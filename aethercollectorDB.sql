...
(8, '', '', 'joseph.stephen.rennie@gmail.com', 'WIN', 'c027653fc953ec76c7f753c6fc172ba5329d80b022bab766acd876d97e434f6f', '97d4c88d7ac9deb728a95eb5e7b3dddb');
...
--
ALTER TABLE `collectionList`
  ADD CONSTRAINT `collectionlist_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `user` (`userID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `collectionlist_ibfk_2` FOREIGN KEY (`cardID`) REFERENCES `cards` (`cardID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
